 ...
 */
public class ClientDistancePacket extends StringPacket {

    public ClientDistancePacket(Map<Address, Integer> table) throws UnsupportedEncodingException {
        super(mapToString(table), PacketUtils.PacketType.DISTANCE);
    }

    public ClientDistancePacket(byte[] data) {
